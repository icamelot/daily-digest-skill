...
1. **Read** `personal-evening-digest_MEMORY.md` first -- it contains context from previous runs.
2. **Read** the whole `TASK_DESCRIPTION.md`!
3. **Follow the assignment** in `TASK_DESCRIPTION.md`!
4. Perform the task conscientiously!
5. **Update** `personal-evening-digest_MEMORY.md` with the current date/time and what you did.
